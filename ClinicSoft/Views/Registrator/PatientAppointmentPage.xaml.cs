    ...
    public partial class PatientAppointmentPage : Page
    {
        ...
        private void LoadAppointments()
        {
            ...
            _allAppointments = context.Appointments
                .Include(a => a.Doctor)
                .Include(a => a.Patient)
                .Where(a => a.Doctor != null && a.Patient != null)
                ...
                .Select(a => new
                {
                    ...
                    PatientFullName = $"{a.Patient.LastName} {a.Patient.FirstName} {a.Patient.MiddleName}".Trim(),
        ...
        private void ApplySearchFilter()
        {
            ...
            else
            {
                ...
                var filtered = _allAppointments
                    .Where(a =>
                        (a.PatientFullName?.ToString().ToLowerInvariant().Contains(searchLower) == true) ||
                        (a.DoctorFullName?.ToString().ToLowerInvariant().Contains(searchLower) == true))
                    .ToList();
